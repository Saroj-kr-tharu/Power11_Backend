...
const {INTERNAL_SERVER_TOKEN,CONTEST_BACKEND_URL,  MATCH_BACKEND_URL,PLAYER_GAME_BACKEND_URL,LEADERBOARD_BACKEND_URL, PAYMENT_BACKEND_URL  } = require('../config/server.config')
