...
const {INTERNAL_SERVER_TOKEN,CONTEST_BACKEND_URL,  MATCH_BACKEND_URL,PLAYER_GAME_BACKEND_URL,LEADERBOARD_BACKEND_URL, PAYMENT_BACKEND_URL, AUTH_BACKEND_URL  } = require('../config/server.config')
...
const SERVICES = {
    ...
    LEADERBOARD:  LEADERBOARD_BACKEND_URL,
...
const internalClient = axios.create({
    ...
    headers: {
        ...
        'x-service-name': 'contest-service',
